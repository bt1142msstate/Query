 ...
 * Extracted from queryHistory.js so status/view metadata is isolated from polling and DOM wiring.
 */
(function initializeQueryHistoryViewHelpers() {
  ...
  window.QueryHistoryViewHelpers = Object.freeze({
    classifyQueryStatus,
    getQueryStatusMeta,
