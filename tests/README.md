...
- Keep architecture tests focused on repo contracts that should fail before runtime: module graph rules, field metadata boundaries, layer-aware maintainability and cognitive-complexity budgets, folder cohesion, Git-history change coupling, large-module budgets, and cache-stable imports.
