 ...
 * Shared DOM caching lives in src/core/domCache.js.
 * @module QueryUI
 */
...
import { MOBILE_FILTER_PANEL_CLASS, createMobileTableControls } from './mobileTableControls.js';
...
const mobileTableControls = createMobileTableControls({
  DOM,
  appUiActions,
...
const closeMobileFilterPanel = mobileTableControls.closeMobileFilterPanel;
...
function updateTableChromeState() {
  ...
  mobileTableControls.syncMobileTableActions();
}
...
function initializeQueryUi() {
  ...
  mobileTableControls.initialize();
  ...
  document.addEventListener('keydown', (event) => {
    if (event.key === 'Escape' && document.body.classList.contains(MOBILE_FILTER_PANEL_CLASS)) {
      mobileTableControls.closeMobileFilterPanel();
    }
  ...
  window.addEventListener('resize', () => {
    updateTableChromeState();
    mobileTableControls.syncMobileBuilderDrawer();
    mobileTableControls.syncMobileFilterPanel();
    mobileTableControls.syncMobileTableActions();
    refreshTableViewport();
  });
