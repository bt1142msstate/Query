...
const forbiddenWindowMemberReads = new Map([
  ...
  ['FormatUtils', 'Import from core/cellDisplayFormatting.js instead of reading format helpers from window'],
  ...
  ['MoneyUtils', 'Import from core/moneyUtils.js instead of reading money helpers from window'],
  ...
  ['ValueFormatting', 'Import from core/valueFormatting.js instead of reading value-formatting helpers from window'],
